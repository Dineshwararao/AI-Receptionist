...
# Initialize the text-to-speech engine outside the function
engine = None
...
def speak_message(message):
    ...
    try:
        ...
        # If the run loop is already started, catch the exception and log a message
        print("Error occurred while speaking the message:", e)
...
def check_availability_ml(date, time, duration, participants):
    try:
        ...
        # If an error occurs, speak an error message
        speak_message("An error occurred: " + str(e))
...
pairs = [
    # Department pairs
    [r"where is the (sales department|section|division)", ["The sales department is located on the 5th floor. Would you like directions?"]],
    [r"(directions|map) for (sales department|section|division)", ["The sales department is located on the 5th floor. You can take the elevator to the 5th floor and follow the signs."]],
    [r"where is the (marketing department|section|division)", ["The marketing department is located on the 3rd floor. Would you like directions?"]],
    [r"(directions|map) for (marketing department|section|division)", ["The marketing department is located on the 3rd floor. You can take the stairs or elevator to the 3rd floor and proceed to the marketing department."]],
    [r"where is the (finance department|section|division)", ["The finance department is located on the 2nd floor. Would you like directions?"]],
    [r"(directions|map) for (finance department|section|division)", ["The finance department is located on the 2nd floor. You can take the stairs or elevator to the 2nd floor and proceed to the finance department."]],
    [r"where is the (hr|human resources department|section|division)", ["The HR department is located on the 4th floor. Would you like directions?"]],
    [r"(directions|map) for (hr|human resources department|section|division)", ["The HR department is located on the 4th floor. You can take the elevator to the 4th floor and follow the signs to the HR department."]],
    [r"where is the (accounting department|section|division)", ["The accounting department is located on the 6th floor. Would you like directions?"]],
    [r"(directions|map) for (accounting department|section|division)", ["The accounting department is located on the 6th floor. You can take the elevator to the 6th floor and proceed to the accounting department."]],
    
    # General pairs for other inquiries
    [r"hi|hello|hey", ["Hello!", "Hey there!", "Hi! How can I assist you today?"]],
    [r"what are you|who are you", ["I am an AI receptionist, here to help.", "I am a new AI model designed to assist the company."]],
    [r"how are you|how are you doing", ["I'm doing well, thank you!", "I'm here to assist you, so I'm doing great!"]],
    [r"what can you do|what do you do", ["I can help you with various tasks such as answering questions, providing information, and more."]],
    [r"what's your name", ["You can call me AI receptionist.", "I'm AI receptionist, your virtual assistant."]],
    [r"bye|goodbye", ["Goodbye!", "See you later!", "Take care!"]],
    [r"thank you|thanks", ["You're welcome!", "My pleasure!", "Anytime!"]],
    [r"(.*) your name(.*)", ["You can call me AI receptionist.", "I'm AI receptionist, your virtual assistant."]],
    [r"(.*) (weather|temperature) (.*)", ["I'm sorry, I can't provide weather information at the moment."]],
]
